        ...
        do {
            ...
            switch (ch) {
                ...
                case 5:
                    ...
                    System.out.println("*************");
                    // i = a.iterator();
                    ListIterator<AddressBookMain> li = a.listIterator();
                    while (li.hasNext()) {
                        AddressBookMain addr = li.next();
                        if (addr.getSrnum() == srnum) {
                            ...
                            li.set(new AddressBookMain(srnum, first_name, last_name, address, state, zip_code, phone_number, email_id));
                            found = true;
                        }
                    }
                    if (!found) {
